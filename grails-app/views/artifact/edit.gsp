                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: artifactInstance, field: 'site', 'errors')}">
                                    <g:select name="site.id" from="${net.calit2.archaeology.database.Site.list()}" optionKey="id" value="${artifactInstance?.site?.id}" noSelection="['null': '']" />
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: artifactInstance, field: 'surveyFeature', 'errors')}">
                                    <g:set var="surveyFeatureId" value="${artifactInstance?.surveyFeature?.id}" scope="request" />
                        ...
                        <!--
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="count"><g:message code="artifact.count.label" default="Count" /></label>
                                </td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="weight"><g:message code="artifact.weight.label" default="Weight" /></label>
                                </td>
                        ...
                        -->
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: artifactInstance, field: 'crate', 'errors')}">
                                    <g:select name="crate.id" from="${net.calit2.archaeology.database.Crate.list(sort: 'id', order: 'asc')}" optionKey="id" value="${artifactInstance?.crate?.id}" noSelection="['null': '']" />
                                </td>
                            </tr>
