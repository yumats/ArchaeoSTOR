...
<html>
            ...
            $(document).ready(function(){
                ...
                $('input#id').keyup(function(){
                    if (event.which != 8 && $(this).val()) {
                        setTimeout("$('input#locationField').focus()", 750);
                    }
                });
                $('input#locationField').keyup(function(){
    ...
    <body>
        <div class="nav">
            ...
            <span class="menuButton"><g:link class="print" controller="artifact" action="printStorageField">Print Location Field Barcodes</g:link></span>
        </div>
        <div class="body">
                    ...
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top">
                                    <g:textField name="locationField" />
                                </td>
                            </tr>
