...
<html>
    ...
    <body>
        ...
        <div class="body">
            ...
            <g:hasErrors bean="${potteryDiagnosticInstance}">
            <div class="errors">
                <g:renderErrors bean="${potteryDiagnosticInstance}" as="list" />
            </div>
            </g:hasErrors>
            <g:form method="post" >
                <g:hiddenField name="id" value="${potteryDiagnosticInstance?.id}" />
                <g:hiddenField name="version" value="${potteryDiagnosticInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: potteryDiagnosticInstance, field: 'registration', 'errors')}">
                                    <g:textField name="registration" value="${potteryDiagnosticInstance?.registration}" />
                                </td>
                            </tr>
                        
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="artifact"><g:message code="potteryDiagnostic.artifact.label" default="Pottery Bulk ID" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: potteryDiagnosticInstance, field: 'artifact', 'errors')}">
                                    <g:textField name="artifact.id" value="${potteryDiagnosticInstance?.artifact?.id}"  />
                                    <g:if test="${potteryDiagnosticInstance?.artifact?.id}">
                                        <g:link controller="artifact" action="edit" id="${potteryDiagnosticInstance?.artifact?.id}">(Show Artifact)</g:link>
                                    </g:if>
                                </td>
                            </tr>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="type"><g:message code="potteryDiagnostic.type.label" default="Type" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: potteryDiagnosticInstance, field: 'type', 'errors')}">
                                    <g:textField name="type" value="${potteryDiagnosticInstance?.type}" />
                                </td>
                            </tr>
                            ...
                            <!-- CATEGORY SELECTOR -->
                            <g:render template="/potteryDiagnostic/categorySelector" />
                            ...
                            <tr class="rim">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: potteryDiagnosticInstance, field: 'rimTreatment', 'errors')}">
                                    <g:select name="rimTreatment" from="${(PotteryDiagnostic.RIM_TREATMENTS + potteryDiagnosticInstance?.rimTreatment).unique()}" value="${potteryDiagnosticInstance?.rimTreatment}" valueMessagePrefix="potteryDiagnostic.rimTreatment"  />
                                </td>
                            </tr>
