                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: siteInstance, field: 'comments', 'errors')}">
                                    <g:textArea cols="40" rows="5" name="comments" value="${siteInstance?.comments}" />
                                </td>
                            </tr>
                        ...
                        <!--
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="artifacts"><g:message code="site.artifacts.label" default="Artifacts" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: siteInstance, field: 'artifacts', 'errors')}">
...
<g:link controller="artifact" action="create" params="['site.id': siteInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'artifact.label', default: 'Artifact')])}</g:link>
                        ...
                        -->
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="surveyFeatures"><g:message code="site.surveyFeatures.label" default="Survey Features" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: siteInstance, field: 'surveyFeatures', 'errors')}">
...
<g:link controller="surveyFeature" action="create" params="['site.id': siteInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'surveyFeature.label', default: 'SurveyFeature')])}</g:link>
